...
- `BlackJackGame-2025/` – Multithreaded client–server Blackjack game developed in Java, featuring socket-based networking, concurrent client handling, and a graphical user interface.
...
- **Tools & Platforms:** Xcode, Git, Google Cloud Platform, Vercel, Oracle APEX, IntelliJ
- **Domains:** Mobile Development (iOS & Android), Web Development, Backend Development, Client–Server Systems, Cloud Computing, Data Structures & Algorithms
